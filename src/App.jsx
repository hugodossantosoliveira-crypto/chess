...
function ExplorerView() {
  ...
  useEffect(() => {
    ...
    const id = setTimeout(() => {
      ...
      const bs = bookState(h);
      let san = null;
      if (bs.inBook && bs.node && bs.node.order.length) san = bs.node.order[0];
      else { const fb = fallbackMove(g2, lastVerbose(g2)); san = fb ? fb.san : null; }
  ...
  return (
    <div className="explorer">
      ...
      <p className="lead">L'app joue un côté coup par coup. Déplace les pièces adverses : elle ajuste sa réponse en suivant l'arbre des ouvertures connues.</p>
